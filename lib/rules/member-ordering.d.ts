...
export declare const DEFAULT_ORDER: readonly ["constructor", "inject", "input-signal", "input-decorator", "output-signal", "output-decorator", "model-signal", "host-binding-signal", "host-binding-decorator", "host-listener-signal", "host-listener-decorator", "view-query-signal", "view-query-decorator", "content-query-signal", "content-query-decorator", "store-select-map", "store-select-signal", "store-select-observable", "store-select-decorator", "signal", "linkedSignal", "computed", "public-static-field", "protected-static-field", "private-static-field", "public-instance-field", "protected-instance-field", "private-instance-field", "getter-setter", "abstract", "public-static-method", "protected-static-method", "private-static-method", "public-instance-method", "protected-instance-method", "private-instance-method"];
